...
<div id="container">
    ...
    <div id="notes-list">
        <div id="notes-list-header" class="header">
            <span class="left" style="color: #000">miNotes</span>
            <span class="right"><a href="index.php?action=new"><img src="images/CreateNote.png" alt="Create new note."></a></span>
        </div>
        {foreach from=$notes item=note}
            <div class="notes-list-item">
                <span class="notes-list-item-title"><a href="index.php?action=navigate&id={$note.id}" {if $note.id eq $ACTIVE_NOTE_ID and isset($ACTIVE_NOTE_ID)}class='active'{/if}>{$note.content|truncate:20}</a></span>
    ...
    <div id="notepad">
        <div id="notepad-header" class="header">
            <span><a href="#" onclick="document.getElementById('updateForm').submit();">Save</a></span>&nbsp;|&nbsp;<span><a href="index.php?action=delete">Delete</a></span>>&nbsp;|&nbsp;<span><a href="" onclick="checkCookie()">Check Cookies</a></span>
